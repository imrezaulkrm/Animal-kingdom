                                ...
                                <div class="content">
                                    ...
                                    <div class="rrr">
                                        <div class="price">
                                            ...
                                            <span class="normal mini-text"><?php echo $fetch_rets['price']; ?> TAKA</span>
                                        </div>
                                    </div>
                                    <div class="quintity" style="display:flex;">
                                        <input type="hidden" name="product_name" value="<?php echo $fetch_rets['name']; ?>">
                                        <input type="hidden" name="product_price" value="<?php echo $fetch_rets['oprice']; ?>">
                                        <input type="hidden" name="product_image" value="<?php echo $fetch_rets['image']; ?>">    
