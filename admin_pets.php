   ...
   if(!empty($image_name)) {
      ...
      if(in_array($image_extension, $allowed_extensions)) {
         ...
         if($image_size > 20000000){
            ...
            $add_product_query = mysqli_query($conn, "INSERT INTO `pets`(name, gname, oprice, price, image) VALUES('$name', '$gname', '$oprice', '$price', '$image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `pets` SET name = '$update_name', gname = '$update_gname', oprice = '$update_oprice', price = '$update_price' WHERE id = '$update_p_id'") or die('query failed');
