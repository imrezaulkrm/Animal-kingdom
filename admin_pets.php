   ...
   if(!empty($image_name)) {
      ...
      if(in_array($image_extension, $allowed_extensions)) {
         ...
         if($image_size > 20000000){
            ...
            $add_product_query = mysqli_query($conn, "INSERT INTO `pets`(name, gname, oprice, price, image, description) VALUES('$name', '$gname', '$oprice', '$price', '$image', '$description')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `pets` SET name = '$update_name', gname = '$update_gname', oprice = '$update_oprice', price = '$update_price', description = '$update_description' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="add-products">
      ...
      <div style="text-align:center;">
         <?php 
            ...
            $number_of_products = mysqli_num_rows($select_pets);
         ?>
   ...
   <h1 class="title">pets products</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea name="description" class="box" placeholder="Enter pets Description" id="" cols="30" rows="5"></textarea>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <img src="uploaded_img/<?php echo $fetch_pets['image']; ?>" alt="">
         <div class="name"><?php echo $fetch_pets['name']; ?></div>
         <div class="name" style="font-style: italic; font-size:15px; "><?php echo $fetch_pets['gname']; ?></div>
         <div class="price" style=" padding: 0.2rem 0; "><p style=" font-size: 2rem; font-weight: bolder;">Offer Price</p></div>
         <div class="price">BDT <?php echo $fetch_pets['oprice']; ?> TAKA</div>
         <div class="price" style=" padding: 0.2rem 0; "><p style=" font-size: 2rem; font-weight: bolder;">Price</p></div>
         <div class="price">BDT <?php echo $fetch_pets['price']; ?> TAKA</div>
         <a href="admin_pets.php?update=<?php echo $fetch_pets['id']; ?>" class="option-btn">update</a>
         <a href="admin_pets.php?delete=<?php echo $fetch_pets['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
   ...
   <form action="" method="post" enctype="multipart/form-data" >
    ...
    <div style="width: 50%; margin: 2px 2px; padding: 2px 2px;">
      ...
      <div style="width: 50%; margin: 2px 2px; padding: 2px 2px;">
         ...
         <textarea name="update_description" class="box" placeholder="Update pets Description" id="" cols="30" rows="7"></textarea>
      </div>
    </div>
      <!-- Button Section -->
