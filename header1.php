            ...
            <div class="wrapper flexitem">
                ...
                <nav class="mobile-hide">
                    <ul class="flexitem second-links">
                        <li class="has-child"><a href="cats.php">Cats</a></li>
                        <li class="has-child"><a href="dogs.php">Dogs</a></li>
                        ...
                        <li class="has-child"><a href="vitamins.php">Supplements & Vitamins</a></li>
                    </ul>
                </nav>
                </div>
            </div>
